...
export const injectChromeWebStoreInstallButton = () => {
    ...
    const ibText = `Add to ${APPLICATION_NAME}`;
    const ibTemplate = `
        <div role="button" class="dd-Va g-c-wb g-eg-ua-Uc-c-za g-c-Oc-td-jb-oa g-c" aria-label="${ibText}" tabindex="0" style="user-select: none;">
            <div class="g-c-Hf">
                <div class="g-c-x">
