...
import { DefaultUserConfig, UserData } from '../../interfaces/user';
...
export class UserManager {
    ...
    private handleIpc() {
        ipcMain.handle(IPCChannel.Users.LIST(), () => {
            return this.normalUsers.map((user): UserData => ({ id: user.id, name: user.name, avatar: user.avatar }));
        });
